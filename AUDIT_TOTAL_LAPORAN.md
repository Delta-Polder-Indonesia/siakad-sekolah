...
| BUG-03 | Domain akademik tanpa backend (P1) | 🔶 **BLUEPRINT: Attendance ✅ · Rapot ✅ · Billing ✅ · Library ✅ · Assignment ✅ · SuratIzin ✅** | **Attendance** (`/api/attendance`), **Rapot/Nilai** (`/api/rapot`, IDOR-safe), **Billing/Tagihan** (`/api/billing`), **Perpustakaan** (`/api/library`), **Tugas Online** (`/api/assignments`, + kolom `content Json?`), **Surat Izin** (`/api/surat-izin`) sudah disambungkan — masing-masing backend CRUD + auth + zod + test, plus wrapper frontend (fallback lokal). Domain tersisa (Roster) terdefer |
...
> - **PHASE 3 (Data/API):** ✅ BUG-04 admin-ops 403 — **selesai.** 🔶 BUG-03 blueprint: **Attendance ✅ · Rapot ✅ · Billing ✅ · Library ✅ · Assignment ✅ · SuratIzin ✅** disambungkan; Roster terdefer.
...
> **Blueprint BUG-03 — ringkasan (Attendance, Rapot, Billing, Library, Assignment, SuratIzin):**
...
> - **Verifikasi:** FE typecheck/lint/build ✅ · FE 314 test ✅ · BE 164 test ✅.
