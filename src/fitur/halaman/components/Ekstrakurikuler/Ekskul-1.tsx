      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-justify">
            ...
            non-formal yang secara sistematis membangun kedisiplinan, kepemimpinan, kemandirian, dan
            solidaritas sosial melalui metode pembelajaran experiential yang terbukti efektif selama
        ...
        <div>
          <p className="text-justify">
            ...
            tidak hanya mengembangkan keterampilan teknis melainkan juga membangun ketahanan mental
            dan kemampuan pemecahan masalah di bawah tekanan. Dalam teori pendidikan, ini dikenal
            sebagai pembelajaran berbasis pengalaman atau experiential learning yang memperkuat
            retensi dan aplikasi pengetahuan secara signifikan dibandingkan metode ceramah
            konvensional.
          </p>
        </div>
        ...
        <div>
          <p className="text-justify">
            ...
            yang relevan dengan dunia kerja modern. Setiap anggota regu memiliki peran dan tanggung
            jawab spesifik, dan keberhasilan kelompok bergantung pada kontribusi dan koordinasi
            setiap individu. Pemimpin regu belajar untuk mendelegasikan tugas, mengambil keputusan
            di bawah ketidakpastian, dan mempertahankan moral kelompok dalam situasi sulit. Anggota
            regu belajar untuk mengikuti arahan dengan disiplin sekaligus berinisiatif ketika
            diperlukan. Dinamika ini mencerminkan realitas organisasi profesional yang akan dihadapi
            siswa dalam karir mereka.
          </p>
        </div>
        ...
        <div>
          <p className="text-justify">
            ...
            kasih sayang sesama manusia, patriotisme, kedisiplinan, keberanian, kesetiaan, hemat dan
            cermat, hingga bertanggung jawab dan dapat dipercaya. Internalisasi nilai-nilai ini
            melalui kegiatan yang menyenangkan dan bermakna membentuk fondasi karakter yang
            kuat—karakter yang tidak hanya relevan untuk kehidupan profesional melainkan juga untuk
            kehidupan sebagai warga negara yang bertanggung jawab.
          </p>
        </div>
        ...
        <div>
          <p className="text-justify">
            ...
            trofi dan penghargaan; ia diukur dari perubahan yang terjadi pada diri setiap siswa yang
            telah menjalani proses kepanduan selama tiga tahun—dari siswa yang awalnya ragu
