...
export default function RisetAirBersihPage() {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-white font-serif text-gray-900">
          ...
          <div className="main-layout m-0 w-full px-6 pt-12 md:px-12 md:pt-16">
            <div className="relative z-[2] flex flex-col gap-1 lg:gap-2">
              <h1 className="text-scale-6 2md:text-[3rem] 2md:leading-tight w-[80%] max-w-[740px] font-bold text-white">
                Inovasi Sistem Pengolahan Air Bersih Sekolah
              </h1>
              <h1 className="text-scale-0-b text-secondary-1 leading-5 font-semibold text-[#facc15]">
                Berbasis Karbon Aktif — {namaSekolahUppercase}
              </h1>
            </div>
          </div>
      ...
      {/* SISA KODE DI BAWAH SAMA PERSIS DENGAN KODE ASLI KAMU */}
      <div className="mx-auto max-w-6xl px-6 pt-14 pb-20 md:px-12 md:pt-16 md:pb-28">
        <div className="border-b-4 border-double border-gray-900 pb-0 text-center">
          <h2 className="text-3xl font-bold tracking-wide text-slate-900 uppercase md:text-4xl">
            Inovasi Sistem Pengolahan Air Bersih Sekolah Berbasis Karbon Aktif
          </h2>
        ...
        <div className="mb-10 pt-8 md:mb-12">
          <p className="mt-4 text-justify text-[15px] leading-relaxed text-slate-800 first-letter:float-left first-letter:mr-2 first-letter:text-4xl first-letter:font-bold">
            Penelitian ini bertujuan untuk mengembangkan sistem pengolahan air bersih yang efisien
            dan ramah lingkungan menggunakan teknologi karbon aktif. Sistem ini dirancang untuk
            memenuhi kebutuhan air bersih di lingkungan sekolah sekaligus menjadi model yang dapat
        ...
        <div className="space-y-6">
          <section>
            ...
            <p className="text-justify text-[15px] leading-relaxed text-slate-800">
              Ketersediaan air bersih merupakan kebutuhan fundamental bagi setiap institusi
              pendidikan. {namaSekolahUppercase} sebagai sekolah unggulan berkomitmen untuk
              mengembangkan solusi inovatif dalam pengelolaan sumber daya air yang berkelanjutan dan
              ramah lingkungan.
            </p>
          </section>
          <section>
            ...
            <p className="text-justify text-[15px] leading-relaxed text-slate-800">
              Penelitian menggunakan metode eksperimental dengan penerapan filter karbon aktif dari
              bahan baku lokal. Parameter yang diukur meliputi tingkat kekeruhan, pH, kadar logam
              berat, dan kandungan bakteri sebelum dan sesudah pengolahan.
            </p>
          </section>
        </div>
      </div>
      <ProgramFooter />
      <FloatingNav contentId="riset-air-bersih" />
    </div>
  );
}
