...
export default function Sdgs17() {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-100 font-sans text-slate-900">
      <header className="sticky top-0 z-50 flex h-14 items-center gap-3 bg-[#038A47] px-4 shadow-md lg:px-8">
        ...
        <div>
          <span className="block text-base leading-none font-bold text-white">SDGs 17</span>
          <span className="text-[11px] text-white/70">Sustainable Development Goals</span>
        </div>
      </header>
      <div className="mx-auto max-w-4xl px-4 py-12">
        <h1 className="text-3xl font-bold">Kemitraan untuk Mencapai Tujuan</h1>
        <p className="mt-4 text-slate-600">Halaman informasi SDGs 17. Isi konten di sini.</p>
      </div>
    </div>
  );
}
