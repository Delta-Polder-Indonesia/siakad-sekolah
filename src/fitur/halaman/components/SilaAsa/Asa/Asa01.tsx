  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-100 font-sans text-slate-900">
      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        <h1 className="text-3xl font-bold">Pelayanan Permohonan Magang/Internship</h1>
        <p className="mt-4 text-slate-600">
          Halaman informasi permohonan magang. Isi konten di sini.
        </p>
      </div>
    </div>
  );
