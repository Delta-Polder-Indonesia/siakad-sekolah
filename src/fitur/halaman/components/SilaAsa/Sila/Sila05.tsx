...
export default function Sila05() {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-slate-100 font-sans text-slate-900">
      <header className="sticky top-0 z-50 flex h-14 items-center gap-3 bg-[#038A47] px-4 shadow-md lg:px-8">
        ...
        <div>
          <span className="block text-base leading-none font-bold text-white">
            Tidak Terdaftar Penerima Beasiswa
          </span>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        <h1 className="text-3xl font-bold">Pelayanan Tidak Terdaftar sebagai Penerima Beasiswa</h1>
        <p className="mt-4 text-slate-600">
          Halaman informasi tidak terdaftar beasiswa. Isi konten di sini.
        </p>
      </div>
    </div>
  );
