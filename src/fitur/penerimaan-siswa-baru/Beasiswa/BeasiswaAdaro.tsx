...
export default function BeasiswaAdaro({ onBack }: Props) {
  return (
    <div className="min-h-screen bg-slate-100 font-sans text-slate-900">
      <header className="sticky top-0 z-50 flex h-14 items-center gap-3 bg-[#0d6e38] px-4 shadow-md lg:px-8">
        ...
        <div>
          <span className="block text-base leading-none font-bold text-white">
            Beasiswa Adaro Foundation 2025
          </span>
      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        <h1 className="text-3xl font-bold">Beasiswa Adaro Foundation 2025</h1>
        <p className="mt-4 text-slate-600">
          Halaman informasi Beasiswa Adaro Foundation 2025. Isi konten di sini nanti.
        </p>
      </div>
    </div>
  );
