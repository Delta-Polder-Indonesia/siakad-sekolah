...
export default function PersJurnalistik({ onBack }: Props) {
  return (
      ...
      <header className="sticky top-0 z-50 flex h-14 items-center gap-3 bg-[#0d6e38] px-4 shadow-md lg:px-8">
        ...
        <div>
          ...
          <span className="text-[11px] text-white/70">
            Ekstrakurikuler Bidang Pers & Jurnalistik
          </span>
        </div>
      </header>

      <div className="mx-auto max-w-4xl px-4 py-12">
        <h1 className="text-3xl font-bold">Ekstrakurikuler Pers dan Jurnalistik</h1>
        <p className="mt-4 text-slate-600">
          Halaman ekstrakurikuler bidang pers dan jurnalistik. Isi konten di sini nanti.
        </p>
      </div>
    </div>
  );
