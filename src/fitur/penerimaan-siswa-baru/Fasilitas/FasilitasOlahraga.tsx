...
export default function FasilitasOlahraga({ onBack }: Props) {
  return (
    <div className="min-h-screen bg-slate-100 font-sans text-slate-900">
      ...
      <div className="mx-auto max-w-4xl px-4 py-12">
        <h1 className="text-3xl font-bold">Fasilitas Olahraga</h1>
        <p className="mt-4 text-slate-600">
          Halaman informasi fasilitas olahraga kampus. Isi konten di sini nanti.
        </p>
      </div>
    </div>
  );
